    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.plusItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                managementCart.plusNumberFood(foodDomains.get(position).getTitle(), new ChangeNumberItemsListener() {
                    @Override
                    public void changed() {
                        foodDomains = managementCart.getListCard();
        ...
        holder.minusItem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                managementCart.MinusNumerFood(foodDomains.get(position).getTitle(), new ChangeNumberItemsListener() {
                    @Override
                    public void changed() {
                        foodDomains = managementCart.getListCard();
                        notifyDataSetChanged();
